...
describe("startOf functions", () => {
  const dates = [new Date('2017-05-26T21:21:34.381Z'), new Date('2018-01-01T00:00:00.000Z'), new Date('2019-12-31T23:59:59.999Z')];
  const functionNames = ['startOfSecond', 'startOfMinute', 'startOfHour', 'startOfDay', 'startOfMonth', 'startOfYear']
